// In order to get the click event of the HTML Tag ID, this script should be loaded after that tag
var CALSS_UG_YES = "ug_yes"; // add this class to enable uyghurch input
var CALSS_UG_NOT = "ug_not"; // add this class to disable uyghurch input
// var isGlobalUyghur = true; // set to false if u dont want to change all input areas
var isGlobalUyghur = false; // set to false if u dont want to change all input areas
...
/// Get click event by HTML tag ID
// document.getElementById('lang').onclick = function (e) {
//     // console.log('Button with ID:lang is clicked', e);
//     var targetNode = document.getElementById('note');
//     changeDirection(targetNode, !isGlobalUyghur);
// }